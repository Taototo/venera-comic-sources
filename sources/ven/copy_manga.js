class CopyManga extends ComicSource {
    ...
    url = "https://cdn.jsdelivr.net/gh/Taototo/venera-comic-sources@main/sources/ven/copy_manga.js"
    ...
    // Keep the currently tested API host; the discovery endpoint may return an unreachable mirror.
    static defaultApiUrl = 'api.copy-manga.com'
    ...
    init() {
        ...
        // Use the stable default host instead of auto-switching to an unverified mirror.
    }
